...
class Blockchain(object):
    ...
    def register_node(self, address):
        ...
        :param address: <str> the address of the node. Eg. 'http://192.168.0.5:5000'
        :return: None
        """
    ...
    def resolve_conflicts(self):
        ...
        by replacing out chain with the longest one on the network.
        :return: <bool> Return True if our chain was replaced, False if not
        """
